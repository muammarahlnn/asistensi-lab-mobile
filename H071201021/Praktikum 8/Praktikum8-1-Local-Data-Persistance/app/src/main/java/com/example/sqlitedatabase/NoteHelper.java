...
public class NoteHelper {
    ...
    public Cursor queryByTitle(String keyword) {
        return database.query(
                DATABASE_TABLE,
                null,
                DatabaseContract.NoteColumn.TITLE + " LIKE ?",
                new String[]{keyword + "%"},
                null,
                null,
                null,
    ...
    public int update(String id, ContentValues values) {
        return database.update(DATABASE_TABLE, values, DatabaseContract.NoteColumn._ID
                + " = ?", new String[]{id});
    }
    public int deleteById(String id) {
        return database.delete(DATABASE_TABLE, DatabaseContract.NoteColumn._ID + " = "
                + id, null);
    }
}
